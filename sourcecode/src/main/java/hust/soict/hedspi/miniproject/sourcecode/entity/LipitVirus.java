...
public class LipitVirus extends Virus{
    private  String effect;
    private String typeOfLipid;

    public LipitVirus(String name, String acidNucleic, String capsid, Integer size, VirusShape shape, String imageURL, String effect, String typeOfLipid) {
